  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ repeat: Infinity, duration: 12, ease: "linear", delay: 0.5 }}
        aria-hidden="true"
      >
        <Image
          src="/icons/codee.png"
      ...
      <motion.div
        ...
        animate={{ y: [0, -20, 0], rotate: [-10, 10, -10], opacity: 1, scale: 1 }}
      ...
      {/* Subheading with typing effect at the end */}
      <motion.p
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3, duration: 1 }}
        className="relative z-10 text-lg sm:text-2xl text-gray-300 max-w-3xl mb-10"
      >
        Our team delivers websites designed to grow your business 🚀 —{" "}
        <span className="font-semibold text-yellow-400">
          <LoopingTypingEffect
            texts={["High-Performing", "Modern & Responsive", "Conversion-Focused"]}
            typingSpeed={100}
            pauseTime={1500}
          />
        </span>
      ...
      <p className="sr-only">
        Our team specializes in building modern, responsive, high-performing, and conversion-focused websites. We deliver premium web experiences that help businesses grow.
      </p>
    </section>
  );
}
